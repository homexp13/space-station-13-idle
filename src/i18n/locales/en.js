export default {
  ...
  chronosphere: {
    ...
    back: "Back",
    timeBankQuestion: "Time Bank?",
    simulationResetQuestion: "Simulation Reset?",
    chronoShopQuestion: "Chrono Shop?",

    bonusesTemplate: "{name} Bonuses ({percent}%)",
  
    backText1: "Listen, I don't know how to break this to you but...",
    backText2: "I have reasons to believe we may be trapped inside a simulation.",
    backText3: "It's nice to see you again, old friend.",
    backText4: "I guess that means the reset worked?",
  
    timeBankText1: "When the simulation is closed, time will continue outside our reality in the \"real world\".",
    timeBankText2: "All of the time that passes out there will get stored in this",
    timeBankText3: "Time Bank",
    timeBankText4: ".",
    timeBankText5: "We can tap into this lost time, get back to where we should be.",
    timeBankText6: "While using the time stored in the",
    timeBankText7: "Time Bank",
    timeBankText8: ", everything in our simulation will run at an accelerated rate.",
    timeBankText9: "And I mean everything:",
    timeBankText10: "Job Actions",
    timeBankText11: "will complete faster, you and your",
    timeBankText12: "Enemies",
    timeBankText13: "will hit in smaller intervals...",
    timeBankText14: "Heck, your",
    timeBankText15: "Health",
    timeBankText16: "will even regenerate quicker. I bet you didn't even know",
    timeBankText17: "Health",
    timeBankText18: "regen was a mechanic, did you?",
    timeBankText19: "Oh, one more thing.  It seems certain exotic forms of matter will interfere with the time acceleration.",
  
    simulationResetText1: "With an",
    simulationResetText2: "Empty Bluespace Time Device",
    simulationResetText3: ", we might just be able to reset this simulation back to where it all started.",
    simulationResetText4: "Unfortunately, my evil",
    simulationResetText5: "Doppelgänger",
    simulationResetText6: "from another timeline is the only person I know that has that kind of",
    simulationResetText7: "Equipment",
    simulationResetText8: ". Any other methods of getting it would be extremely improbable.",
    simulationResetText9: "If you can manage to take him down and bring me the",
    simulationResetText10: "Device",
    simulationResetText11: "... Well, we might be able to get our hands on some",
    simulationResetText12: "Bluespace Time",
    simulationResetText13: ".",
  
    chronoShopText1: "If you reset the simulation, you'll find yourself with some",
    chronoShopText2: "Bluespace Time",
    chronoShopText3: ".",
    chronoShopText4: "You can use this for all sorts of stuff, like upgrading the",
    chronoShopText5: "Time Bank",
    chronoShopText6: "or gaining progress towards certain",
    chronoShopText7: "Jobs",
    chronoShopText8: ".",
    chronoShopText9: "Something tells me the developers of this simulation might even add more options to this shop soon, so you may want to hold off on spending",
    chronoShopText10: "all",
    chronoShopText11: "your",
    chronoShopText12: "Bluespace Time",
    chronoShopText13: "now.",
  
    timeBank: "Time Bank",
    simulationReset: "Simulation Reset",
    chronoShop: "Chrono Shop",
    desiredSpeed: "Desired Speed",
    max: "MAX",
    hours: "HOURS",
    resetPotential: "Reset Potential",
    base: "Base",
    previousResets: "Previous Resets",
    item: "Item",
    enemy: "Enemy",
    job: "Job",
    total: "TOTAL",
    resetInfo1: "By resetting the simulation, you'll gain the Bluespace Time listed",
    resetInfo2: "This Bluespace Time can be used at the Chrono Shop in all future runs",
    resetInfo3: "Other than this Bluespace Time, your save data will be wiped clean",
    infiniteTime: "INFINTE (cheater)",
    remaining: "remaining"
  },
  ...
  chronoModal: {
    ...
    offlineTimeConverted: "Your time offline has been converted for use at the",
    offlineTimeConverted2: ".",
    totalTimeAvailable: "TOTAL TIME AVAILABLE:",
    exportBonus: "You've earned an Export Bonus!",
    exportBonusDescription: "Export your save to keep your data backed up and earn 30 extra minutes in your Time Bank."
  },
